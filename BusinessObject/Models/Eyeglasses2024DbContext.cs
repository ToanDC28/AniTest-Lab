...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.EyeglassesId).HasName("PK__Eyeglass__93A83C7B81B2695D");
        ...
        {
            entity.HasKey(e => e.LensTypeId).HasName("PK__LensType__D6DC1FE63D785C5E");
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__StoreAcc__349DA58671D80942");

            entity.ToTable("StoreAccount");

            entity.HasIndex(e => e.EmailAddress, "UQ__StoreAcc__49A14740C56E3236").IsUnique();
